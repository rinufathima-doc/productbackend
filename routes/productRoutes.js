...
import { createProduct, getAllProducts, getMyProducts, getProductById, updateProduct, deleteProduct, deleteAllProducts, addToCart, getCart, updateCartQuantity, removeFromCart, clearCart } from "../controllers/productController.js";
...
productrouter.post("/", userAuthCheck, upload.single("image"), productValidation, createProduct);
...
productrouter.put("/:id", userAuthCheck, upload.single("image"), productValidation, updateProduct);
